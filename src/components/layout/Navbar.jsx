...
const Navbar = ({ navItems = [
  ...
  return (
    <nav className="bg-white sticky top-0 z-[1000] border-b border-gray-200">
      <div className="flex items-center justify-between py-2 px-4 lg:px-6 relative">
        ...
        {/* Right group: JP Nagar + Notification + Profile — Desktop */}
        <div className="hidden md:flex items-center gap-1 ml-8">
          <div className="flex flex-row border border-gray-300 rounded py-1.5 px-3 w-auto font-semibold h-9 items-center bg-gray-50">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden fixed inset-0 z-[2000] bg-white">
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 overflow-y-auto p-4">
                ...
                <div className="mt-6 flex flex-row border border-gray-300 rounded py-1.5 px-3 w-auto font-semibold h-9 items-center bg-gray-50">
                  <Dot className="h-8 w-8 text-green-500 flex-shrink-0 -ml-2" />
                  <p className="m-0 text-xs whitespace-nowrap text-gray-700">JP Nagar Incubation</p>
                </div>

                {/* Mobile Profile Section */}
                <div className="mt-6 flex items-center gap-2.5 border-none py-1 px-2.5 rounded hover:bg-gray-100 cursor-pointer bg-transparent transition-colors" onClick={() => setShowDropdown(!showDropdown)}>
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#0A66C2] flex items-center justify-center overflow-hidden">
                    <span className="text-white font-semibold text-sm uppercase">TV</span>
                  </div>
                  <div className="flex items-center gap-1.5 flex-shrink-0 text-left flex-1">
                    <div className="flex flex-col">
                      <h6 className="m-0 text-sm font-semibold text-gray-900 leading-none">Tech VenTures pvt ltd</h6>
                      <p className="m-0 text-[10px] text-gray-500 mt-0.5">Company Admin</p>
                    </div>
